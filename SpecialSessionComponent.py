...
class SpecialSessionComponent(SessionComponent):
    ...
    def __init__(self, num_tracks, num_scenes, stop_clip_buttons, control_surface, main_selector):
        ...
        SessionComponent.__init__(self, num_tracks=num_tracks, num_scenes=num_scenes, enable_skinning=True,
                                  name='Session', is_root=True)
        if self._control_surface._mk2_rgb:
    ...
    def _update_stop_clips_led(self, index):
        if ((self.is_enabled()) and (self._stop_track_clip_buttons != None) and (
