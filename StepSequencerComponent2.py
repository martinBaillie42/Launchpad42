...
from StepSequencerComponent import StepSequencerComponent, ButtonElement, NoteSelectorComponent, LoopSelectorComponent, \
    QUANTIZATION_NAMES
...
class MelodicNoteEditorComponent(ControlSurfaceComponent):
                        ...
                        for y in range(7):
                            if self._notes_pitches[play_position * 7 + 6 - y] == 1:
                                if page == self._page:
                                    ...
                                    self._grid_back_buffer[play_x_position][
                                        y] = "StepSequencer2.NoteEditor.PlayInOtherPage"
    ...
    def _update_mode_notes_pitches_button(self):
        if self.is_enabled():
            if (self._mode_notes_pitches_button != None):
                if self._clip != None:
                    self._mode_notes_pitches_button.set_on_off_values("StepSequencer2.Pitch.On",
                                                                      "StepSequencer2.Pitch.Dim")
                    if self._mode == STEPSEQ_MODE_NOTES:
                        self._mode_notes_pitches_button.turn_on()
                    else:
                        self._mode_notes_pitches_button.turn_off()
                else:
                    self._mode_notes_pitches_button.set_on_off_values("DefaultButton.Disabled",
    ...
    def set_mode_notes_pitches_button(self, button):
        ...
        if (self._mode_notes_pitches_button != button):
            ...
            if (self._mode_notes_pitches_button != None):
                assert isinstance(button, ButtonElement)
                self._mode_notes_pitches_button.add_value_listener(self._mode_button_notes_pitches_value,
    ...
    def _update_mode_notes_octaves_button(self):
        if self.is_enabled():
            if (self._mode_notes_octaves_button != None):
                if self._clip != None:
                    self._mode_notes_octaves_button.set_on_off_values("StepSequencer2.Octave.On",
    ...
    def set_mode_notes_octaves_button(self, button):
        ...
        if (self._mode_notes_octaves_button != button):
            ...
            if (self._mode_notes_octaves_button != None):
                assert isinstance(button, ButtonElement)
                self._mode_notes_octaves_button.add_value_listener(self._mode_button_notes_octaves_value,
                                                                   identify_sender=True)
    ...
    def set_mode_notes_velocities_button(self, button):
        ...
        if (self._mode_notes_velocities_button != button):
            ...
            if (self._mode_notes_velocities_button != None):
                assert isinstance(button, ButtonElement)
                self._mode_notes_velocities_button.add_value_listener(self._mode_button_notes_velocities_value,
                                                                      identify_sender=True)
    ...
    def _update_mode_notes_lengths_button(self):
        if self.is_enabled():
            if (self._mode_notes_lengths_button != None):
                if self._clip != None:
                    self._mode_notes_lengths_button.set_on_off_values("StepSequencer2.Length.On",
    ...
    def set_mode_notes_lengths_button(self, button):
        ...
        if (self._mode_notes_lengths_button != button):
            ...
            if (self._mode_notes_lengths_button != None):
                assert isinstance(button, ButtonElement)
                self._mode_notes_lengths_button.add_value_listener(self._mode_button_notes_lengths_value,
                                                                   identify_sender=True)
